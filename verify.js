if (window.location.hostname.indexOf("buyseotoolz.com") > -1) {
...
function callme() {
  ...
  if (window.location.href === "https://thundercontent.com/") {
    window.location.href = "https://thundercontent.com/dashboard";
  } else if (window.location.href === "https://contentbot.ai/") {
    window.location.href = "https://contentbot.ai/app/";
  } else if (window.location.href === "https://nichesss.com/") {
    window.location.href = "https://nichesss.com/home";
  } else if (window.location.href === "https://tool8.toolszap.com/") {
    window.location.href = "https://tool8.toolszap.com/keyword-research";
  } else if (window.location.href === "https://www.closerscopy.com/") {
    ...
    $('a[href="/account/profile/transfer/*"]').remove();
    $('a[href="/YourAccount"]').remove();
    ...
    $('#menu-item-icon-my-account').remove();
    $('#widget-button-tgsw').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("freepik") > -1) {
    $('.popover__container').remove();
    $('.link-contributor').remove();
    $('.gr-auth.gr-auth--logged.gr-auth--premium.gr-auth--not-essential.gr-auth--not-ultimate').remove();
    $('a[href="https://www.freepik.com/pricing"]').remove();
    $('a[href="https://contributor.freepik.com/*"]').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("invideo") > -1) {
    $('.iv-avatar-link').remove();
    $('.sidebar-header').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("vyond") > -1) {
    $('.user-button').remove();
    $('.UpgradeButton_UpgradeButtonContainer__3P8lT').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("powtoon") > -1) {
    $('.MainMenu_footer_39RHW').remove();
    $('.UpgradeButton_UpgradeButtonContainer__3P8lT').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("neuronwriter") > -1) {
    $('.nav-link-user').remove();
    $('.nav-usage-bar').remove();
  } else if (window.location.hostname.indexOf("vidiq") > -1) {
    $('a[href="/plans"]').remove()
    $('.chakra-menu__menu-button').remove();
    $('.intercom-button').remove();
  } else if (window.location.hostname.indexOf("creaitor") > -1) {
    $('#kt_header_user_menu_toggle').remove();
    $('.intercom-button').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("linguix") > -1) {
    $('.header-profile').remove();
    $('.settings-HeaderAvatar').remove();
    $('.intercom-button').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("flaticon") > -1) {
    $('.link-pricing').remove();
    $('#gr_user_menu').remove();
    $('.intercom-button').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("epidemicsound") > -1) {
    $('.css-15knyve').remove();
    $(".src-mainapp-___MessageContainer__messageContainer___DciBh").remove();
  } else if (window.location.hostname.indexOf("gocharlie") > -1) {
    $('#headlessui-menu-button-1').remove();
  } else if (window.location.hostname.indexOf("renderforest") > -1) {
    $('#header-anonym-menu').remove();
    $('.pricingButtonLink').remove();
  } else if (window.location.hostname.indexOf("renderforest") > -1) {

  } else if (window.location.hostname.indexOf("glorify") > -1) {
    $('[data-brand-id="161417"]').remove();
    $('#userProfile').parent('button').remove();
    $('a[href="#modal-share-design"]').next('div').remove();
    $('a[href="https://app.glorify.com/welcome/logout"]').remove();
    $('a[href="https://www.glorify.com/affiliates/"]').remove();
    $('a[href="https://app.glorify.com/settings"]').remove();
    $('a[href="https://app.glorify.com/favourites"]').remove();
    $('a[href="https://app.glorify.com/brands"]').remove();
    $('a[href="https://app.glorify.com/dashboard#!"]').remove();
  } else if (window.location.hostname.indexOf("icons8") > -1) {
    $('.i8-header__login').remove();
    $('a[href="/pricing"]').remove();
    $('#app_support').remove();
  } else if (window.location.hostname.indexOf("elevenlabs") > -1) {
    $('#headlessui-menu-button-P0-4').remove();
  } else if (window.location.hostname.indexOf("airbrush") > -1) {
    $('.header-right').remove();
    $('a[href="/logout"]').remove();
    $('a[href="/account-plan"]').remove();
    $('#tidio-chat').remove();
  } else if (window.location.hostname.indexOf("supermachine") > -1) {
    $('div.bubble-element.Text.baTaRoaX.clickable-element:contains("Logout")').remove();
    $(".intercom-lightweight-app-launcher.intercom-launcher").remove();
  } else if (window.location.hostname.indexOf("lex") > -1) {
    $('.toolbar-right').remove();
  } else if (window.location.hostname.indexOf("canva") > -1) {
